...
<div>
    <div class="page_title page__ col-lg-12 col-md-12 col-sm-12 no-padding">
        <div class="dear_title">
            <h2 class="title_head_ border_content2">
                <a href="tintuc" title="Tin tức nổi bật">
                    Tin tức nổi bật</a>
            </h2>
        </div>
    </div>
    ...
    <div class="list-blogs">
        <div class="blog_list_item">
            ...
            <article class="blog-item blog-item-list ">
                <div class="blog-item-thumbnail img1" onclick="window.location.href='chitiettintuc';">
                ...
                <div class="ct_list_item">
                    <h3 class="blog-item-name"><a class="text2line" href="chitiettintuc" title="Juno ra mắt bộ sưu tập mùa lễ hội, kết hợp cùng Diễm My - Lan Ngọc">Juno ra mắt bộ sưu tập mùa lễ hội, kết hợp cùng Diễm My - Lan Ngọc</a></h3>
                    <span class="post_">
            ...
            <span class="view_more_blog"><a href="tintuc" title="Xem thêm Tin tức nổi bật">Xem thêm</a></span>
        </div>
    </div>
</div>
</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="item_blog_owl">
                        <article class="blog-item blog-item-grid row">
                            <div class="wrap_blg">
                                <div class="blog-item-thumbnail img1 col-lg-6 col-md-6 col-sm-6 col-xs-12 margin-top-5" onclick="window.location.href='chitiettintuc';">						
                                    <a href="chitiettintuc">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content_ar blog_large_item">
                                    ...
                                    <a href="chitiettintuc" class="readmore">Đọc tiếp <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </article>
                    </div>
                    ...
                    <div class="item_blog_owl">
                        <article class="blog-item blog-item-grid row">
                            <div class="wrap_blg">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content_ar blog_large_item">
                                    <h3 class="blog-item-name"><a class="text2line" href="chitiettintuc" title="Đỉnh cao phong độ 'anh trai mưa' tuổi tứ tuần showbiz Việt là đây!">Đỉnh cao phong độ 'anh trai mưa' tuổi tứ tuần showbiz Việt là đây!</a></h3>
                                    <p class="meta">
