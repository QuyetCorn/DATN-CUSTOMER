    ...
    <div class="row">
        <div class="col-xs-12 a-left">
            ...
            <li class="home">
                ...
                <li >
                <h2 style="color: #3cc113;text-align: center" class="vc_custom_heading">CHÂN THÀNH CẢM ƠN QUÝ KHÁCH HÀNG ĐÃ QUAN TÂM ĐẾN SMARKET<p></p>
                ...
                <li >
                    <h2 style="color: #81d742;text-align: left" class="vc_custom_heading">CHÍNH SÁCH CHẤT LƯỢNG CỦA SMARKET</h2>
                        <div class="wpb_text_column wpb_content_element ">
                            ...
                            <h4><p>Với chính sách chất lượng được thiết lập và tuân thủ trong quá trình hoạt động, SMARKET luôn suy nghĩ và hướng tới cung cấp những sản phẩm, dịch vụ tốt nhất cho khách hàng.</p></h4>
                            <h4><p>Những cam kết SMARKET luôn kết dành cho khách hàng như sau:</p></h4>
                            <h4><p>1- Chúng tôi cam kết mang lại sự chuyên nghiệp, thuận lợi nhất cho khách hàng từ việc đặt hàng đến khi nhận sản phẩm.</p></h4>
                            <h4><p>2- Hoàn tiền 100% nếu khách hàng không hài lòng về chất lượng sản phẩm.</p></h4>
                            <h4><p>3- Hỗ trợ tư vấn Online 24/7</p></h4>
                            <h4><p>4- Sản phẩm bảo hành 6 tháng – 1 năm</p></h4>
                            <h4><p>5- Giao hàng đúng hẹn như đã thỏa thuận với khách hàng.</p></h4>
                            <h4><p>6- Kiểm tra hàng thoái mái trước khi thanh toán.</p></h4>
                            <h4><p>7- Sản phẩm sau cùng được đóng gói đẹp, giao hàng tận nơi, giao hàng toàn quốc theo yêu cầu của khách hàng.<p><br></h4>
                        </div>
                    </div>
                </li>
            </ul>
